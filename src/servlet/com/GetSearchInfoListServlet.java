 ...
 * 
 * */
public class GetSearchInfoListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		String jsonStr = req.getParameter("getSearchInfoList");
		...
		// 调用WebService的相关方法
		App app = new App();
		Dxmsglist dxmsgList = app.getAppSoap().getSearchInfoList(uid, classid,
				keyword, pages, pageNum);
